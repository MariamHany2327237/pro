...
public class HomePageGlEventListener extends AnimationListener {

    String textureName = "mainback.png";
    ...
    public void init(GLAutoDrawable glAutoDrawable) {
        ...
        try {
            texture = TextureLoader.readTexture(assetsFolderName + "//" + textureName , true);
